...
// Expanded job data with more variety across specializations
const expandedJobsData = [
  // AI / ML Domain - CSE Specialization
  {
  ...
  // Data Science Domain - Multiple Specializations
  {
    title: 'Data Analyst',
    company: 'DataCorp',
    location: 'Mumbai',
  ...
  // Additional jobs for different specializations

  // Mechanical Engineering Jobs
  {
    title: 'Design Engineer',
    company: 'AutoDesign Corp',
    location: 'Chennai',
    salary: '₹4-6 LPA',
    domain: 'Design Engineering',
    description: `AutoDesign Corp seeks a creative Design Engineer to develop innovative mechanical designs for automotive components and systems. You'll work on product design from concept to manufacturing, using CAD software to create detailed drawings and 3D models. Responsibilities include analyzing design requirements, conducting feasibility studies, collaborating with manufacturing teams, performing design validation and testing, and ensuring compliance with industry standards. You'll use tools like SolidWorks, AutoCAD, CATIA for design work, perform finite element analysis (FEA), create technical documentation, and work closely with cross-functional teams. This role offers exposure to cutting-edge automotive technologies, opportunities to work on electric vehicle components, hybrid systems, and advanced materials. You'll participate in design reviews, prototype development, and testing phases while learning about manufacturing processes, quality control, and cost optimization. Career growth includes advancement to Senior Design Engineer, Lead Designer, and Design Manager roles. Perfect for mechanical engineering graduates passionate about automotive design, innovation, and creating products that impact millions of users. The position offers excellent learning opportunities in product development lifecycle, design thinking, and engineering best practices in a collaborative environment focused on innovation and excellence.`,
    eligibility: 'B.Tech Mechanical Engineering with CAD skills.',
    educationLevel: 'Graduate',
    course: 'B.Tech / B.E',
    specialization: 'Mechanical',
    skills: ['SolidWorks', 'AutoCAD', 'CATIA', 'FEA', 'Product Design'],
    applyLink: 'https://example.com/jobs/mech1'
  },

  // Civil Engineering Jobs
  {
    title: 'Construction Management Trainee',
    company: 'BuildRight Construction',
    location: 'Delhi',
    salary: '₹3-5 LPA',
    domain: 'Construction Management',
    description: `BuildRight Construction seeks a motivated Construction Management Trainee to learn and contribute to large-scale construction projects including residential complexes, commercial buildings, and infrastructure development. You'll work under experienced project managers to understand project planning, execution, and delivery processes. Responsibilities include assisting in project scheduling, monitoring construction progress, coordinating with subcontractors and suppliers, ensuring quality control and safety compliance, and maintaining project documentation. You'll learn to use project management software like Primavera P6, MS Project, and construction-specific tools for planning and tracking. The role involves site visits, progress monitoring, cost tracking, and reporting to senior management. You'll gain exposure to different construction methodologies, building codes and regulations, safety protocols, and quality assurance processes. Training includes understanding construction materials, structural systems, MEP coordination, and sustainable construction practices. Career progression includes advancement to Assistant Project Manager, Project Manager, and Senior Management roles. This position offers excellent learning opportunities in construction industry best practices, project management methodologies, and leadership skills. Perfect for civil engineering graduates interested in construction management, project delivery, and building infrastructure that shapes communities and cities.`,
    eligibility: 'B.Tech Civil Engineering with project management interest.',
    educationLevel: 'Graduate',
    course: 'B.Tech / B.E',
    specialization: 'Civil',
    skills: ['Project Management', 'Primavera P6', 'Construction Planning', 'Quality Control', 'Safety Management'],
    applyLink: 'https://example.com/jobs/civil1'
  },
  ...
  // Electrical Engineering Jobs
  {
    ...
    description: `PowerGrid Solutions seeks a dedicated Power Systems Engineer to work on electrical power generation, transmission, and distribution systems. You'll be involved in designing, analyzing, and maintaining power systems infrastructure that serves millions of customers. Responsibilities include power system analysis and modeling, load flow studies, short circuit analysis, protection system design, and renewable energy integration. You'll use specialized software like ETAP, PSS/E, MATLAB/Simulink for system analysis and simulation. The role involves working on grid modernization projects, smart grid technologies, and sustainable energy solutions including solar and wind power integration. You'll collaborate with utility companies, regulatory bodies, and equipment manufacturers to ensure reliable and efficient power delivery. Training includes understanding power system protection, control systems, SCADA systems, and energy management systems. You'll participate in field work, commissioning activities, and troubleshooting power system issues. Career growth includes advancement to Senior Power Systems Engineer, Protection Engineer, and Technical Manager roles. This position offers excellent opportunities to work on critical infrastructure, contribute to energy transition initiatives, and develop expertise in emerging technologies like microgrids, energy storage, and electric vehicle charging infrastructure. Perfect for electrical engineering graduates passionate about power systems, renewable energy, and sustainable infrastructure development.`,
    eligibility: 'B.Tech Electrical Engineering with power systems knowledge.',
    educationLevel: 'Graduate',
    course: 'B.Tech / B.E',
    specialization: 'Electrical',
    skills: ['Power Systems', 'ETAP', 'MATLAB', 'Protection Systems', 'Renewable Energy'],
    applyLink: 'https://example.com/jobs/elec1'
  },
  ...
  // Business Analytics Jobs
  {
    ...
    description: `DataInsights Inc seeks a Business Intelligence Analyst to transform business data into actionable insights that drive strategic decision-making across the organization. You'll work with large datasets from multiple sources to create comprehensive reports, dashboards, and analytics solutions that support business operations and growth initiatives. Responsibilities include designing and developing BI dashboards using tools like Tableau, Power BI, and QlikView, creating automated reporting solutions, performing data analysis to identify trends and patterns, and collaborating with business stakeholders to understand requirements. You'll work with SQL databases, data warehouses, and ETL processes to ensure data quality and accessibility. The role involves creating KPI frameworks, performance metrics, and scorecards for different business units including sales, marketing, operations, and finance. You'll conduct ad-hoc analysis, support business planning processes, and present findings to senior management. Training includes advanced analytics techniques, data visualization best practices, and business domain knowledge across various industries. Career progression includes advancement to Senior BI Analyst, BI Manager, and Data Analytics Lead roles. This position offers excellent opportunities to work with cutting-edge BI tools, contribute to data-driven decision making, and develop expertise in business analytics and intelligence. Perfect for MBA graduates with business analytics specialization who are passionate about turning data into business value and strategic insights.`,
    eligibility: 'MBA Business Analytics with BI tools experience.',
    educationLevel: 'Post Graduate',
    course: 'MBA',
    specialization: 'Business Analytics',
    skills: ['Tableau', 'Power BI', 'SQL', 'Data Analysis', 'Business Intelligence'],
    applyLink: 'https://example.com/jobs/bi1'
  },

  // HR Specialization Jobs
  {
    title: 'HR Generalist',
    ...
    description: `PeopleFirst HR seeks an HR Generalist to support comprehensive human resources functions across talent acquisition, employee relations, performance management, and HR operations. You'll work closely with business leaders and employees to ensure effective HR service delivery and support organizational growth objectives. Responsibilities include managing end-to-end recruitment processes, conducting interviews and candidate assessments, onboarding new employees, maintaining employee records and HRIS systems, and supporting performance management cycles. You'll handle employee relations issues, conduct exit interviews, assist with policy development and implementation, and ensure compliance with labor laws and regulations. The role involves supporting learning and development initiatives, coordinating training programs, managing employee engagement activities, and assisting with compensation and benefits administration. You'll work with HR analytics to track key metrics like turnover, time-to-hire, and employee satisfaction. Training includes understanding employment law, HR best practices, conflict resolution, and organizational development. You'll gain exposure to different HR functions and develop skills in communication, problem-solving, and stakeholder management. Career progression includes advancement to Senior HR Generalist, HR Business Partner, and HR Manager roles. This position offers excellent opportunities to develop comprehensive HR expertise, work with diverse employee populations, and contribute to building positive workplace culture. Perfect for MBA HR graduates passionate about people management, organizational development, and creating employee experiences that drive business success.`,
    eligibility: 'MBA HR with recruitment and employee relations knowledge.',
    educationLevel: 'Post Graduate',
    course: 'MBA',
    specialization: 'HR',
    skills: ['Recruitment', 'Employee Relations', 'HRIS', 'Performance Management', 'HR Analytics'],
    applyLink: 'https://example.com/jobs/hr1'
  },
  ...
  // Banking and Finance Jobs
  {
    ...
    description: `Capital Markets Ltd seeks an Investment Banking Analyst to support corporate finance transactions including mergers and acquisitions, IPOs, debt financing, and strategic advisory services. You'll work with senior bankers and clients to execute complex financial transactions that drive business growth and market expansion. Responsibilities include financial modeling and valuation analysis, preparing pitch books and client presentations, conducting industry and company research, supporting due diligence processes, and creating transaction documentation. You'll use advanced Excel modeling techniques, perform DCF analysis, comparable company analysis, and precedent transaction analysis. The role involves working with clients across various industries, analyzing market trends, and supporting deal execution from origination to closing. You'll participate in client meetings, management presentations, and roadshows while learning about capital markets, regulatory requirements, and transaction structures. Training includes financial statement analysis, accounting principles, corporate finance theory, and investment banking processes. You'll develop skills in financial modeling, presentation development, project management, and client relationship management. Career progression includes advancement to Associate, Vice President, and Managing Director levels. This position offers excellent opportunities to work on high-profile transactions, develop expertise in corporate finance, and build relationships with senior executives and institutional investors. Perfect for finance graduates passionate about investment banking, capital markets, and advising companies on strategic financial decisions that shape their future growth and success.`,
    eligibility: 'MBA Finance/M.Com with strong analytical and modeling skills.',
    educationLevel: 'Post Graduate',
    course: 'MBA',
    specialization: 'Finance',
    skills: ['Financial Modeling', 'Valuation', 'Excel', 'Investment Banking', 'Capital Markets'],
    applyLink: 'https://example.com/jobs/ib1'
  }
];

async function populateExpandedJobs() {
  try {
    // Connect to database
    await connectDB();
    ...
    // Insert new expanded jobs
    const insertedJobs = await Job.insertMany(expandedJobsData);
    ...
    const jobsBySpecialization = {};
    insertedJobs.forEach(job => {
      if (!jobsBySpecialization[job.specialization]) {
        jobsBySpecialization[job.specialization] = 0;
      }
      jobsBySpecialization[job.specialization]++;
    });
    
    console.log('\nJobs inserted by specialization:');
    Object.entries(jobsBySpecialization).forEach(([specialization, count]) => {
      console.log(`${specialization}: ${count} jobs`);
    });

    // Display summary by education level
    const jobsByEducationLevel = {};
    insertedJobs.forEach(job => {
      if (!jobsByEducationLevel[job.educationLevel]) {
        jobsByEducationLevel[job.educationLevel] = 0;
      }
      jobsByEducationLevel[job.educationLevel]++;
    });
    
    console.log('\nJobs inserted by education level:');
    Object.entries(jobsByEducationLevel).forEach(([level, count]) => {
      console.log(`${level}: ${count} jobs`);
    });
    
    console.log('\nExpanded database population completed successfully!');
    process.exit(0);
